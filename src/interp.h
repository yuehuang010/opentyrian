...
// explosion) across plain/darken/blend variants, and for the dynamic per-level
// enemy banks' hue-band `_filter` variants via an on-demand recolored-frame
// cache; the 8-bit blit is never suppressed, so this is purely additive.
